...
public class _3DMaze_
{
    ...
    */
    ...
    public int FindRow()
    {
        int row = Assistant.instance.firstDigitOfSerial().Value;

        List<Indicator> unlitIndicators = new List<Indicator>();

        foreach (Indicator i in Assistant.instance.bomb.indicators)
        {
            if (!i.lit & i.visible)
            {
                unlitIndicators.Add(i);
            }
        }

        foreach (Indicator indicator in unlitIndicators)
        {
    ...
    {
        int column = Assistant.instance.lastDigitOfSerial();

        List<Indicator> litIndicators = new List<Indicator>();
        ...
        foreach (Indicator indicator in litIndicators)
        {

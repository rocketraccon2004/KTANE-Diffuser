...
partial class frmEdgeworkInput
{
    /// <summary>
    ...
    {
        portPlateNumTextBox = new TextBox();
        label1 = new Label();
        batteryHolderTextBox = new TextBox();
        batteryHolderLabel = new Label();
        carLitCheckBox = new CheckBox();
        carVisibleCheckBox = new CheckBox();
        clrLitCheckBox = new CheckBox();
        clrVisibleCheckBox = new CheckBox();
        frkLitCheckBox = new CheckBox();
        frkVisibleCheckBox = new CheckBox();
        frqLitCheckBox = new CheckBox();
        frqVisibleCheckBox = new CheckBox();
        indLitCheckBox = new CheckBox();
        msaVisibleCheckBox = new CheckBox();
        msaLitCheckBox = new CheckBox();
        indVisibleCheckBox = new CheckBox();
        nsaLitCheckBox = new CheckBox();
        trnVisibleCheckBox = new CheckBox();
        sndLitCheckBox = new CheckBox();
        nsaVisibleCheckBox = new CheckBox();
        trnLitCheckBox = new CheckBox();
        sndVisibleCheckBox = new CheckBox();
        sigLitCheckBox = new CheckBox();
        sigVisibleCheckBox = new CheckBox();
        bobLitCheckBox = new CheckBox();
        bobVisibleCheckBox = new CheckBox();
        ...
        portPlateNumTextBox.TabIndex = 58;
        // 
        // label1
        // 
        ...
        batteryHolderLabel.TabIndex = 57;
        batteryHolderLabel.Text = "Battery Holder:";
        // 
        // carLitCheckBox
        // 
        ...
        carVisibleCheckBox.TabIndex = 6;
        carVisibleCheckBox.Text = "Visible";
        carVisibleCheckBox.UseVisualStyleBackColor = true;
        // 
        // clrLitCheckBox
        // 
        ...
        clrVisibleCheckBox.TabIndex = 8;
        clrVisibleCheckBox.Text = "Visible";
        clrVisibleCheckBox.UseVisualStyleBackColor = true;
        // 
        // frkLitCheckBox
        // 
        ...
        frkVisibleCheckBox.TabIndex = 10;
        frkVisibleCheckBox.Text = "Visible";
        frkVisibleCheckBox.UseVisualStyleBackColor = true;
        // 
        // frqLitCheckBox
        // 
        ...
        frqVisibleCheckBox.TabIndex = 12;
        frqVisibleCheckBox.Text = "Visible";
        frqVisibleCheckBox.UseVisualStyleBackColor = true;
        // 
        // indLitCheckBox
        // 
        ...
        msaVisibleCheckBox.TabIndex = 16;
        msaVisibleCheckBox.Text = "Visible";
        msaVisibleCheckBox.UseVisualStyleBackColor = true;
        // 
        // msaLitCheckBox
        // 
        ...
        indVisibleCheckBox.TabIndex = 14;
        indVisibleCheckBox.Text = "Visible";
        indVisibleCheckBox.UseVisualStyleBackColor = true;
        // 
        // nsaLitCheckBox
        // 
        ...
        trnVisibleCheckBox.TabIndex = 24;
        trnVisibleCheckBox.Text = "Visible";
        trnVisibleCheckBox.UseVisualStyleBackColor = true;
        // 
        // sndLitCheckBox
        // 
        ...
        nsaVisibleCheckBox.TabIndex = 18;
        nsaVisibleCheckBox.Text = "Visible";
        nsaVisibleCheckBox.UseVisualStyleBackColor = true;
        // 
        // trnLitCheckBox
        // 
        ...
        sndVisibleCheckBox.TabIndex = 22;
        sndVisibleCheckBox.Text = "Visible";
        sndVisibleCheckBox.UseVisualStyleBackColor = true;
        // 
        // sigLitCheckBox
        // 
        ...
        sigVisibleCheckBox.TabIndex = 20;
        sigVisibleCheckBox.Text = "Visible";
        sigVisibleCheckBox.UseVisualStyleBackColor = true;
        // 
        // bobLitCheckBox
        // 
        ...
        bobVisibleCheckBox.TabIndex = 4;
        bobVisibleCheckBox.Text = "Visible";
        bobVisibleCheckBox.UseVisualStyleBackColor = true;
        // 
        // submitButton
        // 
        ...
        Controls.Add(batteryHolderLabel);
        Controls.Add(carLitCheckBox);
        Controls.Add(carVisibleCheckBox);
        Controls.Add(clrLitCheckBox);
        Controls.Add(clrVisibleCheckBox);
        Controls.Add(frkLitCheckBox);
        Controls.Add(frkVisibleCheckBox);
        Controls.Add(frqLitCheckBox);
        Controls.Add(frqVisibleCheckBox);
        Controls.Add(indLitCheckBox);
        Controls.Add(msaVisibleCheckBox);
        Controls.Add(msaLitCheckBox);
        Controls.Add(indVisibleCheckBox);
        Controls.Add(nsaLitCheckBox);
        Controls.Add(trnVisibleCheckBox);
        Controls.Add(sndLitCheckBox);
        Controls.Add(nsaVisibleCheckBox);
        Controls.Add(trnLitCheckBox);
        Controls.Add(sndVisibleCheckBox);
        Controls.Add(sigLitCheckBox);
        Controls.Add(sigVisibleCheckBox);
        Controls.Add(bobLitCheckBox);
        Controls.Add(bobVisibleCheckBox);
        Controls.Add(submitButton);
        Controls.Add(portLabel);
        Controls.Add(trnLabel);
        Controls.Add(sndLabel);
        Controls.Add(sigLabel);
        Controls.Add(nsaLabel);
        Controls.Add(msaLabel);
        Controls.Add(frqLabel);
        Controls.Add(frkLabel);
        Controls.Add(indLabel);
        Controls.Add(clrLabel);
        Controls.Add(carLabel);
        Controls.Add(bobLabel);
        Controls.Add(indicatorLabel);
        Controls.Add(batteryTextBox);
